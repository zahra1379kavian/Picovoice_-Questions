...
if __name__ == "__main__":
    ...
    print(f"probability of at least {sample_n} rainy days: {result}")
...
and the desired probability is obtained by summing the upper tail of this distribution, (P(S_m >= n) = \sum_{k=n}^m P_m(k)).
"""